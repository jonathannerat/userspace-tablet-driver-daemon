...
#ifndef USERSPACE_TABLET_DRIVER_DAEMON_STAR_G640S_H
#define USERSPACE_TABLET_DRIVER_DAEMON_STAR_G640S_H


#include "xp_pen_unified_device.h"

class star_g640s : public xp_pen_unified_device {
public:
    star_g640s();
...
#endif //USERSPACE_TABLET_DRIVER_DAEMON_STAR_G640S_H
